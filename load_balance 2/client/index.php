...
<center>
  <div class="wrapper">
	...
	<ul>
		...
		<li id="current"><a href="index.php">User</a></li>
	...
	<div>
		<div id="tdiv">
			...
			<table width="100%" cellpadding="5px" cellspacing="5px">
				...
				<tr>
					<td style="text-align: center" colspan="2"><label class="label"><b>Client Login Panel</b></label></td>
				</tr>
				<tr><td colspan="2" style="text-align: center">
				<label style="color:Yellow"><?php if(isset($_SESSION['studenterr'])){echo $_SESSION['studenterr'];}?></label>
					</td>
				<tr>
					...
					value="<?php if(isset($_SESSION['susername'])){echo $_SESSION['susername'];}?>"/></td>
				</tr>
				<tr>
					<td style="text-align: right"><label class="label">Password <b>:</b></label></td>
					<td style="text-align: left"><input type="password" id="txtpassword" name="txtpassword" placeholder="Password" autocomplete="off" value="<?php if(isset($_SESSION['spassword'])){echo $_SESSION['spassword'];}?>"/></td>
				</tr>
				<tr>
					<td colspan="2"></td>
				</tr>
