  ...
  <div class="wrapper">
    ...
    <div style="padding-top:20px;">
		...
		<div id="right-bar">
			<div id="nav1">
				<ul class="tabrow">
					<li class="selected"><a href="frmAdmin.php" class="active1">Server List</a></li>
					<li><a href="frmAddServer.php" class="active1">Add Server</a></li>
			...
			<form id="">
				<table width="100%" cellspacing="0px" cellpadding="5px">
					<tr class="tablehead">
						...
						<td>
							<font color="white"><b>Server</b></font></td>
						<td>
							<font color="white"><b>IP Address</b></font></td>
						<td>
							<font color="white"><b>Bucket</b></font></td>
						<td>
						...
						else
						{
							...
							while($row = mysql_fetch_array($result))
							{
								echo("
										...
										<td><b>".$row['ip']."</b></td>
										<td><b>".$row['bandwidth']."</b></td>
										<td><a href=\"\" 
										style=\"text-decoration:none; color:blue\"><b>Update</b></a></td>
										<td><a href=\"\" 
										style=\"text-decoration:none; color:Red\"><b>Delete</b></a></td></tr>
								");
								$i++;
							}
						}
