		...
		<div id="right-bar">
			<div id="nav1">
				<ul class="tabrow">
					...
					<li class="selected"><a href="frmFile.php" class="active1">File</a></li>
				</ul>
			</div>
			<div>
				<form id="addserver" method="post" action="uploadfile.php">
					<table width="100%" cellspacing="5px" cellpadding="5px">
						...
						<tr>
							<td style="text-align: right" width="30%"><label class="label1">Upload File <span class="asterik">*</span> <b>:</b></label></td>
